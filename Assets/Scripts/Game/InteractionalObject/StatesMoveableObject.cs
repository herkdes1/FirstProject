namespace Base.Game.InteractionalObject
{
    ...
    public class StateMoveableYZ : IState
    {
        public StateMoveableYZ(MoveableObjectContext context) => context.Movement = new Command<MovementActionToTarget>(context.MovementActions, m => m.MovementYZ());
    ...
    public class StateNonMoveable : IState
    {
        ...
        public virtual void Handle(Context context) => context.State = new StateMoveableYZ((MoveableObjectContext)context);
    }
